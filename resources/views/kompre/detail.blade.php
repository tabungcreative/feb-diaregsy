        ...
        <div class="row my-5 d-flex justify-content-center">
            <div class="col-md-8 my-5">
                <div class="card p-4">
                    ...
                    <h4 class="mx-auto mt-4">Detail pendaftaran ujian komprehensif</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="fw-bold">{{ $kompre->email }} </p>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword4">Bukti Pembayaran</label>
                                        <p class="fw-bold"><a href="{{asset('storage/' . $kompre->bukti_pembayaran)}}" target="_blank"> preview </a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <p class="fw-bold"> {{ $kompre->no_whatsapp }} </p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="fw-bold">{{ $kompre->pembimbing1 }} </p>
                                        <p class="fw-bold">{{ $kompre->pembimbing2 }} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
