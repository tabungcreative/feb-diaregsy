        ...
        <div class="row py-5">
            <div class="col-md-12 mx-auto">
                <div class="card p-4">
                    ...
                    <h4 class="mx-auto mt-4">Mahasiswa Terdaftar Bimbingan Tugas Akhir </h4>
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @foreach($bimbinganSkripsi as $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->pembimbing1 }} <br> {{ $value->pembimbing2 }}</td>
                                        <td>
                                            @if($value->is_verify)
        ...
        <div class="col-lg-6 md-12 mx-auto">
            <div class="card">
                <div class="image mx-auto mt-5">
                    <img src={{asset('/img/logo-feb.png')}} class="img-flui" alt=" logo-diaregsi" width="150px">
                </div>
                <div class="card-body text-center">
                    <img src={{asset('/img/alur-akademik/infografis%20feb-05.png')}} class="img-fluid" alt=" logo-diaregsi">
                </div>
            </div>
        </div>
    </div>
