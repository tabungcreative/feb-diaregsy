                    ...
                    @foreach($spl as $value)
                        <tr>
                            ...
                            <td class="d-flex ">
                                ...
                                <a href="{{ route('admin.spl.edit', $value->nim) }}" class="btn btn-primary mx-1">Edit</a>
                                <form method="post" action="{{ route('admin.spl.delete', $value->id ) }}" onsubmit="return confirm('Konfirmasi Hapus Data . !!')">
                                    @csrf
                                    @method('DELETE')
