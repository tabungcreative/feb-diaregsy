...
@section('content')
    ...
    <div class="card">
        <div class="d-flex align-items-center p-5 flex-row justify-content-between flex-wrap">
            <div>
                <h5 class="bg-white flex-grow-1">Daftar Pendaftaran Yudisium Tahun 2021</h5>
                <a href="{{ route('admin.yudisium.export') }}" class="btn btn-success">
                ...
                <table class="table table-hover table-bordered table-striped">
                    ...
                    @foreach($yudisium as $value)
                        <tr>
                            ...
                            <td class="d-flex ">
                                <form method="post" action="{{ route('admin.yudisium.verify', $value->id) }}" onSubmit="if(!confirm('Yakin ingin verifikasi pendaftaran ?')){return false;}">
                                    @csrf
                                    <button type="submit" class="btn btn-primary mx-1">Verifikasi</button>
                                </form>
                                <a href="{{ route('admin.yudisium.detail', $value->id) }}" class="btn btn-info">Detail</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
