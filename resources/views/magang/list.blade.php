    ...
    <div class="row py-5">
        <div class="col-md-12 mx-auto">
            <div class="card p-4">
                ...
                <h4 class="mx-auto mt-4">Mahasiswa Terdaftar Magang </h4>
                <div class="card-body">
        ...
        <div class="col-lg-6 md-12 mx-auto">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="https://is3.cloudhost.id/storage-feb/assets/images/alur-akademik/infografis%20feb-01.png" class="img-fluid" alt=" logo-diaregsi">
                </div>
            </div>
        </div>
    </div>
