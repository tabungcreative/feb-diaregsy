        ...
        <div class="row my-5 d-flex justify-content-center">
            <div class="col-md-8 my-5">
                <div class="card p-4">
                    ...
                    <h4 class="mx-auto mt-4">Ubah data pendaftaran Ujian Skripsi</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('ujianAkhir.update', $ujianAkhir->id) }}" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pembimbing1"
                                       ...
                                       placeholder="ex: 085xx" value="{{ old('pembimbing1',$ujianAkhir->pembimbing1) }}">
                                @error('pembimbing1')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pembimbing2"
                                       ...
                                       placeholder="ex: 085xx" value="{{ old('pembimbing2',$ujianAkhir->pembimbing2) }}">
                                @error('pembimbing2')
